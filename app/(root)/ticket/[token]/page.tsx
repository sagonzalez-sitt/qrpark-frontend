...
export default function TicketPage({ params }: Props) {
  ...
  useEffect(() => {
    const loadTicket = async () => {
      try {
        // Obtener información del ticket por token
        ...
        // Marcar como delivered si no lo está
        if (!ticketData.delivered) {
          try {
            ...
            // No lanzar error, el ticket se puede mostrar igual
          }
        }
    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <header className={styles.header}>
          <div className={styles.logo}>🅿️ QRPark</div>
            ...
            <div className={styles.ticketDetails}>
              ...
              {ticket.exit_timestamp && (
                <div className={styles.detailRow}>
                  ...
                  <span className={styles.detailValue}>
                    {formatDate(ticket.exit_timestamp)}
                  </span>
                </div>
              )}
